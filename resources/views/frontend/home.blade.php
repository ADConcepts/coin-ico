...
@section('content')
   ...
   <div class="slider">
    ...
    <div class="container">
        ...
        <div class="title-1">
        <h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">The future will be Crypted and United beyond <br class="hidden-xs"> borders and nationalities.</h1>

        <div class="part wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
            <h2>Shape the future</h2>
            <p>Every owner of shares/cpoins will be able to vote on decisions regarding the future path and development of the organization.</p>
        </div>

        <div class="part wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
            <h2>Own the company</h2>
            <p>As shareholder of coins, you’ll receive dividends for your investment simply by holding on to your shares/coins.</p>
        </div>

        <div class="part wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
            <h2>Be the change</h2>
            <p>Start proposals for new projects to develop and suggest changes or new features for existing services.</p>
        </div>
    ...
    <div class="planned">
        ...
        <div class="project-right">
            ...
            <div class="right-text wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <p>New and extended know features. Fee-less trading rewards for pre-ICO participants. Competitions, Chain-Trades, Free Signals and more...</p>
        ...
        <div class="project-right">
            ...
            <div class="right-text wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <p>Enhanced secure Off-Chain transactions. Registered users can send owned currency instantly without paying fees, gas or mining reward.</p>
        ...
        <div class="project-right alt">
            ...
            <div class="right-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <p>Ease of use trusted system online payment gateway for merchants to easily accept any of our supported digital currencies.</p>
        ...
        <div class="project-right">
            ...
            <div class="right-text wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <p>Earn coins and/or FIAT by being active in the community, creating content, providing solutions, developing use-cases and more...</p>
        ...
        <div class="project-right alt">
            ...
            <div class="right-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <p>Develop new application for our platform and sell, rent or offer them for free having access to all curremcies supported on our exchange.</p>
        ...
        <div class="project-right">
            ...
            <div class="right-text wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <p>Seamless and feeless. Access to all your currencies in one place. Personalized settings for maximum security.</p>
        ...
        <div class="project-right alt">
            ...
            <div class="right-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <p>Your data in one single place. Update your data only in one place to verify at participating services without sharing crucial information</p>
   ...
   <div class="gradient-bg">
       ...
       <div class="container bg">
           ...
           <div class="ford-words wow slideInLeft" data-wow-delay="0.5" data-wow-duration="2s">
               <h2>“It is well enough that people of the nation do not under&shy;stand our banking and monetary system, for if they did, I believe there would be a revolution before tomorrow morning.””</h2>
               <p>Henry Ford, 1922</p>
           </div>
                    ...
                    <ul class="timeline-centered">
                        ...
                        <li class="timeline-entry active">
                            ...
                            <div class="timeline-entry-inner">
                                <time class="timeline-time" datetime="2014-01-10T03:45"><span>16 jan</span></time>
                        ...
                        <li class="timeline-entry left-aligned">
                            ...
                            <div class="timeline-entry-inner">
                                <time class="timeline-time" datetime="2014-01-10T03:45"><span>1 feb</span></time>
                        ...
                        <li class="timeline-entry">
                            ...
                            <div class="timeline-entry-inner">
                                <time class="timeline-time" datetime="2014-01-09T13:22"><span>28 feb</span></time>
                        ...
                        <li class="timeline-entry left-aligned">
                            ...
                            <div class="timeline-entry-inner">
                                <time class="timeline-time" datetime="2014-01-10T03:45"><span>15 mar</span></time>
   ...
   <div class="gradient-bg">
    ...
    <div class="container">
        ...
        <div class="developer">
            ...
            <ul class="lang">
                <li class="wow zoomIn" data-wow-delay="0.5" data-wow-duration="1s"><a href="#"><img src="/images/php.png" alt="img" class="img-responsive"></a></li>
                <li class="wow zoomIn" data-wow-delay="1" data-wow-duration="1.5s"><a href="#"><img src="/images/v.png" alt="img" class="img-responsive"></a></li>
                <li class="wow zoomIn" data-wow-delay="2" data-wow-duration="2s"><a href="#"><img src="/images/laravel.png" alt="img" class="img-responsive"></a></li>
                <li class="wow zoomIn" data-wow-delay="3" data-wow-duration="2.5s"><a href="#"><img src="/images/mysql.png" alt="img" class="img-responsive"></a></li>
            </ul>
            ...
            <ul class="coin-logo">
                ...
                <li class="wow zoomIn" data-wow-delay="0.5" data-wow-duration="1s"><a href="#"><img src="/images/bitcoin.png" alt="img" class="img-responsive"></a> </li>
                <li class="wow zoomIn" data-wow-delay="1" data-wow-duration="1.5s"><a href="#"><img src="/images/cryptcoin.png" alt="img" class="img-responsive"></a> </li>
                <li class="wow zoomIn" data-wow-delay="2" data-wow-duration="2s"><a href="#"><img src="/images/coinnoon.png" alt="img" class="img-responsive"></a> </li>
                <li class="wow zoomIn" data-wow-delay="3" data-wow-duration="2.5s"><a href="#"><img src="/images/smatico.png" alt="img" class="img-responsive"></a> </li>
